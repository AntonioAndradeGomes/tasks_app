            ...
            schemas: {
                Task: {
                    ...
                    properties: {
                        ...
                        hexColor: {
                            type: 'string',
                            description: 'Hex color code for the task',
                        },
                        user_id: {
                            type: 'string',
                        ...
                        due_at: {
                            ...
                            format: 'date-time',
                            description:
                                'Date on which the user believes he will complete the task',
                        },
                        completed_at: {
                            type: 'string',
                            format: 'date-time',
                        ...
                        created_at: {
                            type: 'string',
                            format: 'date-time',
                            description: 'Date on which the task was created',
                        },
                        updated_at: {
                            type: 'string',
                            format: 'date-time',
            ...
            '/auth/login': {
                post: {
                    ...
                    responses: {
                        ...
                        400: {
                            description:
                                'Bad request - Invalid credentials or user not found',
                            content: {
                                'application/json': {
                                    schema: {
            ...
            '/auth/signup': {
                post: {
                    ...
                    responses: {
                        ...
                        400: {
                            description:
                                'Bad request - Invalid credentials or user already exists',
                            content: {
                                'application/json': {
                                    schema: {
                                        $ref: '#/components/schemas/ErrorResponse',
