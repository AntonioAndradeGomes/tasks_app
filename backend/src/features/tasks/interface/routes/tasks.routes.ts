...
import { createTaskValidator, deleteTaskValidator, updateTaskValidator } from "../validators/TaskValidators";
...
taskRoutes.put('/:id', authMiddleware, updateTaskValidator, async (req, res) => controller.updateTask(req, res));
